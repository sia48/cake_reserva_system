    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-jet-input id="shop_id" class="block mt-1 w-full" type="text" name="shop_id" :value="old('shop_id')" required autofocus />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="target_num" class="block mt-1 w-full" type="number" name="target_num" required/>
            </div>
